...
<html>
  <head>
		...
		<link href="${pageContext.request.contextPath}/static/exam/css/question-add.css" rel="stylesheet">
		<link href="${pageContext.request.contextPath}/static/common/css/jquery-ui-1.9.2.custom.min.css" rel="stylesheet" type="text/css" />
		<style type="text/css">
...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					<form id="question-add-form" style="margin-top:20px;width: 70%;">
				...
				<div class="form-line question-knowledge">
					...
					<div class="form-line form-question-opt" style="display: block;width: 100%;">
					...
					<div class="form-line correct-answer form-question-answer-text" style="display: none;">
						...
						<div class="form-line">
							<input id="btn-save" value="保存" type="submit" class="btn-primary df-submit">
						</div>
					</form>
				</div>
			</div>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/js/jquery-ui-1.9.2.custom.min.js"></script>
		<%-- <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/js/uploadify/jquery.uploadify3.1Fixed.js"></script> --%>
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/exam/js/all.js"></script>
		<%-- <script type="text/javascript" src="${pageContext.request.contextPath}/static/exam/js/question-upload-img.js"></script> --%>
