 ...
 */
@Service
public class WxMpInDBConfigStorage implements WxMpConfigStorage {
	...
	public void init(String appId) {
		...
		this.appId = appId;
		this.secret = wxApp.getSecret();
		this.token = wxApp.getToken();
		this.aesKey = wxApp.getAesKey();
	}
	...
	@Override
	public synchronized void updateCardApiTicket(String cardApiTicket,
			int expiresInSeconds) {
		this.cardApiTicket = cardApiTicket;
		// 预留200秒的时间
		this.cardApiTicketExpiresTime = System.currentTimeMillis()
				+ (expiresInSeconds - 200) * 1000l;
	}
	...
	public String toString() {
		return "WxMpInMemoryConfigStorage{" + "appId='" + this.appId + '\''
				+ ", secret='" + this.secret + '\'' + ", token='" + this.token
				+ '\'' + ", partnerId='" + this.partnerId + '\''
				+ ", partnerKey='" + this.partnerKey + '\'' + ", accessToken='"
				+ this.accessToken + '\'' + ", aesKey='" + this.aesKey + '\''
				+ ", expiresTime=" + this.expiresTime + ", http_proxy_host='"
				+ this.http_proxy_host + '\'' + ", http_proxy_port="
				+ this.http_proxy_port + ", http_proxy_username='"
				+ this.http_proxy_username + '\'' + ", http_proxy_password='"
				+ this.http_proxy_password + '\'' + ", jsapiTicket='"
				+ this.jsapiTicket + '\'' + ", jsapiTicketExpiresTime='"
				+ this.jsapiTicketExpiresTime + '\'' + ", cardApiTicket='"
				+ this.cardApiTicket + '\'' + ", cardApiTicketExpiresTime='"
				+ this.cardApiTicketExpiresTime + '\'' + ", tmpDirFile='"
				+ this.tmpDirFile + '\'' + '}';
	}
	...
	public void setApacheHttpClientBuilder(
