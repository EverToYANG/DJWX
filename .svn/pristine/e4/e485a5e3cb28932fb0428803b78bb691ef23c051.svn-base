...
<body>
	<div id="top">
		<div id="top_logo"><a href="${pageContext.request.contextPath}/index">党建服务平台</a></div>
		<div id="top_links">
			<div id="top_op">
				...
				<ul class="nav pull-right">
					<li class="dropdown">
						<a href="#" class="btn dropdown-toggle" data-toggle="dropdown"> <i class="icon-white icon-globe"></i> 
						${wxapp.title }
						<b class="caret"></b>
						</a>
					</li>
		...
		$(function() {
			$('#left_menu_tab li').click(function() {
				var index = $(this).index();
					...
					/* $('#nav_module').find('img')
								.attr('src',
										ctx+ '/static/skin/images/common/module_'
														+ (index + 1) + '.png'); */
					$('#left_menu_tab li')
							.each(function(i, ele) {
								if (i != index) {
