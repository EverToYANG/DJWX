...
<div class="widget-box">
							...
							<div class="widget-content nopadding">
									...
									<div class="widget-content nopadding">
								<form class="form-horizontal" method="post" action="pwdDo.do" name="form" id="form"  onsubmit="return formCheck();">
                                   <input type="hidden" name="id" id="id" value="${loginMember.id }">
									...
									maxLength=50 type=text name=loginname value="${loginMember.loginname }" onpropertychange="checkLoginName(this)">
...
<script src="${pageContext.request.contextPath}/member/js/pwd.js"></script>
