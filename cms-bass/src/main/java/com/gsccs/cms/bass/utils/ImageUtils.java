...
public class ImageUtils {
	...
	public static void pressText(String targetImg, String pressText,
		...
		try {
			...
			if (y < 0) {					//Y值超出图片左上角
				y = heightDiff / 2;
			} else if (y > heightDiff) {	//Y值超出图片右下角
				y = heightDiff;
			}else{							//左下角显示水映文字
				y = heightDiff;
			}
	...
	public static void main(String[] args) throws IOException {
		String sourcePic = "D:\\testpic\\2.png";
		String targetPic = "D:\testpic\3.png";
		
		//pressImage(sourcePic, targetPic, 5000, 5000, 0f);
		pressText(sourcePic, "图片水印测试YYYYYYYYYYYYYYYYY0", "宋体", Font.PLAIN | Font.ITALIC, 10,
				Color.BLACK, 10, 10, 1);
