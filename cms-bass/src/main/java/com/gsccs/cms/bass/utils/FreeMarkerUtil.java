...
public class FreeMarkerUtil {
	 ...
	 * @throws IOException
	 */
	public static void createHTML(File dir,
			Map<String, Object> data, String templatePath, String htmlPath)
			throws IOException, TemplateException {
	 ...
	 * @throws IOException 
	 */
	public static void createWriter(File dir,
			Map<String, Object> data, String templatePath, Writer writer)
	...
	public static Configuration initCfg(ServletContext context,
		...
		FreeMarkerConfigurer freeMarkerConfigurer = (FreeMarkerConfigurer) SpringContextUtil
	 ...
	 * @throws IOException 
	 */
	public static Configuration initCfg(File dir,
			String templetEncode) throws TemplateModelException, IOException {
