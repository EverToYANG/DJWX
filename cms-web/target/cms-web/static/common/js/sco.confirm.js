...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			//2014-7-23  nxj 修改
			//$modal = $('<div class="modal" style="margin-top:-50px" id="' + this.options.target.substr(1) + '"><div class="modal-body inner"/><div class="modal-footer"><a class="btn cancel" href="#" data-dismiss="modal">取 消</a> <a href="#" class="btn btn-danger" data-action="1">确 定</a></div></div>').appendTo(this.options.appendTo).hide();
			$modal = $('<div class="modal" style="margin-top:10px" id="' + this.options.target.substr(1) + '"><div class="modal-body inner"/><div class="modal-footer"><a class="btn cancel" href="#" data-dismiss="modal">取 消</a> <a href="#" class="btn btn-danger" data-action="1">确 定</a></div></div>').appendTo(this.options.appendTo).hide();
