					...
					<div class="widget-content nopadding">
						<form class="form-horizontal" method="post" action="" name="form" id="form">
							...
							<div class="control-group">
								...
								<div class="controls" style="margin-left: 190px;">${msg.title }</div>
							</div>
							<div class="control-group">
								<label class="control-label" style="width: 160px">内容</label>
								<div class="controls" style="margin-left: 190px;">${msg.content }</div>
							</div>
							<div class="control-group">
								<label class="control-label" style="width: 160px">已读</label>
								<div class="controls" style="margin-left: 190px;">${"1"==msg.isread ?"是":"否"}</div>
							</div>
							<div class="control-group">
								<label class="control-label" style="width: 160px">系统站内信</label>
								<div class="controls" style="margin-left: 190px;">${"1"==msg.issys ?"是":"否"}</div>
							</div>
							<div class="control-group">
								<label class="control-label" style="width: 160px">发送时间</label>
								<div class="controls" style="margin-left: 190px;">${msg.addtimeStr }</div>
							</div>

							<div class="control-group">
								<div class="controls" style="margin-left: 190px;">
									<a onclick="history.back(-1)" class="btn btn-primary">返 回</a>
								</div>
							</div>
						</form>
					</div>
