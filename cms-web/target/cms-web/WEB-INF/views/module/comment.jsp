...
<div class="widget-box collapsible">
							...
							<form class="form-search" action="comment.do" method="post">
			<input type="hidden" id="pageFuncId" name="pageFuncId" value="${param.pageFuncId }"/>
			
								会员:
								<input name="membername" size="10" type="text" maxlength="50"
									class="input-medium search-query" value="${param.membername }"  />
			匿名:
								<select name="isanonymous" style="width:70px">
									<option value="" >全部
							...
							对象ID:
								...
								<input name="objid" size="10" type="text" maxlength="50"
									class="input-medium search-query" value="${param.objid }" />
							内容:
							...
							<fs:order colName="状态" col="state"/>
									...
									<tbody>
										...
										<tr>
											...
											<TD>${bean.objtypeStr }(${bean.objid })</TD>
											<TD><textarea readonly="readonly" 
			type=text  cols="60" rows="3">${bean.content }</textarea>
											</TD>
...
<script src="${pageContext.request.contextPath}/static/common/js/checkAll.js"></script>
            <script src="${pageContext.request.contextPath}/static/admin/cms/js/comment.js"></script>
