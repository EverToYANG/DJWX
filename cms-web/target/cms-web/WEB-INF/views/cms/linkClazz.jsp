...
<div class="widget-box collapsible">
							<div class="widget-title">
								...
								<h5>${link.type=="1"?"下拉":"" }${link.type=="2"?"图片":"" }${link.type=="3"?"文字":"" }链接分类搜索</h5>
							...
							<form class="form-search" action="linkClazz.do">
...
<div class="widget-box">
							<div class="widget-title">
								...
								<h5>${link.type=="1"?"下拉":"" }${link.type=="2"?"图片":"" }${link.type=="3"?"文字":"" }链接分类</h5>
