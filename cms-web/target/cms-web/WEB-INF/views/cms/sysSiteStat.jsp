...
<div class="widget-box collapsible">
							...
							<form class="form-search" action="statSysSiteStat.do">
			<input type="hidden" id="pageFuncId" name="pageFuncId" value="${param.pageFuncId }"/>
			<input type="hidden" name="export" id="export" value=""/>
			
				站点名称：
								
								<input name="sitename" type="text" maxlength="50" value="${ info.sitename}"
...
<div class="widget-box">
    ...
    <div>
        <div id="jqChart" style="width: 99%; height: 300px;">
						...
						<TD  >
							<a href='${pageContext.request.contextPath}/sitePreview.htm?id=${bean.site }' target='_blank'>${bean.sitename }</a>
						</TD>
						<TD  >${bean.countnum }
						</TD>
										</tr>
