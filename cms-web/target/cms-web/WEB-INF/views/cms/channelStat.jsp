...
<div class="widget-box collapsible">
							...
							<form class="form-search" action="statChannelStat.do">
			...
			<input type="hidden" name="export" id="export" value=""/>
								...
								<input name="channelname" type="text" maxlength="50" value="${ info.channelname}"
...
<div class="widget-box">
    ...
    <div>
        <div id="jqChart" style="width: 99%; height: 300px;">
						...
						<TD  >
							<a href='${pageContext.request.contextPath}/channelPreview.do?id=${bean.channel }' target='_blank'>${bean.channelname }</a>
						</TD>
						<TD  >${bean.countnum }
						</TD>
										</tr>
