...
<div class="widget-box collapsible">
							...
							<form class="form-search" action="statInfoVisit.do">
			<input type="hidden" id="pageFuncId" name="pageFuncId" value="${param.pageFuncId }"/>
			<input type="hidden" name="export" id="export" value=""/>
			信息名称：
								
								<input name="infoname" type="text" maxlength="50" value="${ visit.infoname}"
...
<div class="widget-box">
    ...
    <div>
        <div id="jqChart" style="width: 99%; height: 300px;">
						...
						<TD  >
							<a href='${pageContext.request.contextPath}/infoPreview.do?id=${bean.infoid }' target='_blank'>${bean.infoname }</a>
						</TD>
						<TD  >${bean.countnum }
						</TD>
										</tr>
