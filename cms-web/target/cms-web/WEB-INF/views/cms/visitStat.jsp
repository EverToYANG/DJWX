...
<body>
			...
			<div class="widget-box collapsible">
				...
				<div class="collapse in" id="collapseOne">
					<div class="widget-content">
						<form class="form-search" action="statVisit.do">
							<input type="hidden" id="pageFuncId" name="pageFuncId"
								value="${param.pageFuncId }" /> <input type="hidden"
								name="export" id="export" value="" /> 更新周期: <label><input
								type="radio" name="statType" value="year"
								${(statType==null || statType=="" || statType=="year")?"checked":"" } />年</label>
							<label><input type="radio" name="statType" value="month"
								${(statType=="month")?"checked":"" } />月</label> <label><input
								type="radio" name="statType" value="day"
								${(statType=="day")?"checked":"" } />日</label> <label><input
								type="radio" name="statType" value="week"
								${(statType=="week")?"checked":"" } />星期</label> 时间范围： <input
								name="starttime" id="starttime"
								class="input-medium search-query Wdate" type="text" size="24"
								value="${visit.starttimeStr }"
								onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
							至 <input name="endtime" id="endtime"
								class="input-medium search-query Wdate" type="text" size="24"
								value="${visit.endtimeStr }"
								onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
	...
	<link rel="stylesheet" type="text/css"
		href="${pageContext.request.contextPath}/static/common/js/jquery.jqChart.css" />
	<link rel="stylesheet" type="text/css"
		href="${pageContext.request.contextPath}/static/common/js/jquery.jqRangeSlider.css" />
	<link rel="stylesheet" type="text/css"
		href="${pageContext.request.contextPath}/static/smoothness/jquery-ui-1.8.21.css" />
	<script src="${pageContext.request.contextPath}/static/common/js/jquery-1.7.2.min.js"
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/static/common/js/jquery.jqChart.min.js"
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/static/common/js/jquery.jqRangeSlider.min.js"
		type="text/javascript"></script>
