...
<div class="widget-box collapsible">
							...
							<form class="form-search" action="statSysVisit.do">
			...
			<input type="hidden" name="export" id="export" value=""/>
								 ...
								 <label ><input type="radio" name="statType" value="week" ${(statType=="week")?"checked":"" }/>星期</label>
									时间范围：
									<input name="starttime" id="starttime"  class="input-medium search-query Wdate"  type="text" size="24" value="${visit.starttimeStr }"  onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
									至
									<input name="endtime" id="endtime"  class="input-medium search-query Wdate"  type="text" size="24" value="${visit.endtimeStr }"  onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
