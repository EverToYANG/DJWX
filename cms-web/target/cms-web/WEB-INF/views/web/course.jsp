...
<body style="background-color: rgb(254, 251, 243);" verify_mobile="0">
	...
	<div id="c_main" class="apply-form" >
		...
		<%-- <div style="height: 30px;line-height:30px; background: #eee;">&nbsp;&nbsp;学习资料</div>
		<c:forEach items="${infoList }" var="info">
		<div class="label clearfix">
			<span class="label-left" style="width: 77%;"><a href="http://wxpc.lzglglj.cn:70/2016/06/30/7846.html">${info.infotitle }</a></span>
			<div class="label-right" style="width: 23%;">2016-05-30</div>
		</div>
		</c:forEach> --%>
	</div>
	
	<div id="c_info" class="apply-form" style="display: none;">
