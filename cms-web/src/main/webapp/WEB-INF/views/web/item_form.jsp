		...
		<div class="label clearfix"
			...
			<div class="label-right">
				<form id="fm1" enctype="multipart/form-data" action="" method="post">
					<div class="img-btns">
						<span type="img-1" class="img-btn" onclick="UPloadimg('file0',this)">+ </span> <span type="img-2"
							class="img-btn" onclick="UPloadimg('file1',this)">+</span> <span
							type="img-3" class="img-btn" onclick="UPloadimg('file2',this)">+</span>
						<span type="img-4" class="img-btn"
							onclick="UPloadimg('file3',this)">+</span>
					</div>
