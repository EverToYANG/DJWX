...
<div class="widget-box collapsible">
							...
							<form class="form-search" action="statChannelVisit.do">
			<input type="hidden" id="pageFuncId" name="pageFuncId" value="${param.pageFuncId }"/>
			<input type="hidden" name="export" id="export" value=""/>
			
								栏目名称：
								
								<input name="channelname" type="text" maxlength="50" value="${ visit.channelname}"
									class="input-medium search-query"  />
									时间范围：
									<input name="starttime" id="starttime"  class="Wdate"  type="text" size="24" value="${visit.starttimeStr }"  onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
									至
									<input name="endtime" id="endtime"  class="Wdate"  type="text" size="24" value="${visit.endtimeStr }"  onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
...
<div class="widget-box">
    ...
    <div>
        <div id="jqChart" style="width: 99%; height: 300px;">
						...
						<TD  >
							<a href='${pageContext.request.contextPath}/channelPreview.do?id=${bean.channelid }' target='_blank'>${bean.channelname }</a>
						</TD>
						<TD  >${bean.countnum }
						</TD>
										</tr>
                ...
                series: [
                            {
								...
								['${bean.channelname}', ${bean.countnum}]
								</c:forEach>
								]
                            },
                        ]
