...
<body>
			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					<form class="form-horizontal" enctype="multipart/form-data"
						method="post" action="siteConfigDo.do" name="form" id="form" />
					<input type="hidden" name="parid" value="${site.parid }"> 
					<input type="hidden" name="id" id="siteId" value="${site.id }"> 
					<input type="hidden" name="pageFuncId" id="pageFuncId"
					...
					<div class="tab-content">
							...
							<div class="control-group">
								...
								<div class="controls" style="margin-left: 120px;">
									<input type="text" name="sitedomain" id="sitedomain"
										...
										data-placement="top" title="请输入站点域名,设置后可以通过此域名直接访问此站点" />请输入站点域名,设置后可以通过此域名直接访问此站点
								</div>
							</div>
								...
								<div class="controls" style="margin-left: 120px;">
									...
									<c:if
										...
										<span id="oldLogoSpan"> <a
											href="/${site.sourcepath  }${site.logo }?date=<%=UUID.randomUUID() %>"
											target="_blank"> <img
												src="/${site.sourcepath  }${site.logo }?date=<%=UUID.randomUUID() %>"
												style="width: 200px" title="点击查看大图" />
										</a> <a href="javascript:delLogo()" class="btn">删除原有LOGO</a> <br />
										</span>
									</c:if>
						...
						<div class="tab-pane" id="other">
							...
							<div id="sourcepathDiv" class="control-group">
								...
								<div class="controls" style="margin-left: 120px;">
									<INPUT id=sourcepath oninput="checkLoginName(this)"
										...
										title="请输入站点的源文件目录名，此站点的相关文件将放在此目录下" /> <span
										style="color: Red;">请输入站点的源文件目录名，此站点的相关文件将放在此目录下</span> <span class="help-inline"
										id="sourcepathHelp"></span>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls" style="margin-left: 120px;">
									<label style="float: left"><input type="radio"
										name="state" value="1" checked />是</label> <label style="float: left"><input
							...
							<div class="control-group">
								...
								<div class="controls" style="margin-left: 120px;">
									<input type="text" name="url" id="url" style="width: 260px"
										value="${site.url }" rel="tooltip" data-placement="top"
										title="请输入站点的外部链接，设置后点击此站点将直接进入此外部链接" />请输入站点的外部链接，设置后点击此站点将直接进入此外部链接
								</div>
							</div>
							 -->
							<div class="control-group">
							...
							<div id="templetDiv" class="control-group">
								...
								<div class="controls" style="margin-left: 120px;">
									<input type="hidden" name="templet"
										...
										data-placement="top" title="请选择站点的页面模板"
										name=site.templetName value="${site.templetName }" />
									
									<a href="#" class="btn" onclick="syncRes()" rel="tooltip"
										data-placement="top" title="点击后将把模板资源文件(resources文件夹)复制并覆盖到此站点">同步资源文件</a>
							...
							<div class="control-group">
								...
								<div class="controls" style="margin-left: 120px;">
									<input type="hidden" name="htmlquartz_id"
										value="${htmlquartz.id }" />
									<table>
										<tr>
	...
	<script
		src="${pageContext.request.contextPath}/static/admin/cms/js/siteConfig.js"></script>
