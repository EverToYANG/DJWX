package com.gsccs.cms.auth.utils;
...
public class AuthConst {
	...
	public static final String UNKNOWN_ACCOUNT_EXCEPTION="账号不存在!";
    ...
    public static final String CURRENT_WXAPP = "current_wxapp";
    public static final String CURRENT_SITE_ROOT = "siteRoot";
	 ...
	 * 管理员角色
	 */
	public static final String SYS_M="sys_m";
	
	/**
	 * 省级管理员
	 */
	public static final String ROLE_M_P="m_p";
	/**
	 * 市级管理员
	 */
	public static final String ROLE_M_C="m_c";
	/**
	 * 区县管理员
	 */
	public static final String ROLE_M_Q="m_q";
	/**
	 * 乡镇街道
	 */
	public static final String ROLE_M_X="m_x";
