...
import com.gsccs.cms.core.dao.MailMapper;
...
public class MailServiceImpl implements MailService {
	...
	public void proSearchParam(Mail mail, Criteria criteria) {
		if (mail != null) {
			...
			if (mail.getQuerycode() != null
					&& mail.getQuerycode().trim().length() > 0) {
			...
			if (mail.getIsopen() != null
					&& mail.getIsopen().trim().length() > 0) {
